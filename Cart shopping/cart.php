...
<body>
  <nav class="navbar navbar-expand-md bg-dark navbar-dark">
    <!-- Brand -->
    <a class="navbar-brand" href="..\index.html" style="text-transform: uppercase;font-weight: bold;letter-spacing: 3px;display: inline-flex;align-items: center;column-gap: .25rem; padding-left: 120px;"><iconify-icon icon="mingcute:watch-line"></iconify-icon> Watch Mart</a>
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link" href="index.php"><iconify-icon icon="ph:watch-bold"></iconify-icon>Products</a>
        </li>
        <!-- <li class="nav-item">
